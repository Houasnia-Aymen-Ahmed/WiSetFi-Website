...
const NavBar = () => {
  ...
  return (
    <nav className="w-full bg-gradient-to-l from-[#304a6c] to to-[#163759] overflow-hidden flex py-5 justify-between items-center navbar shadow-2xl px-10 rounded-[25px] ">
      <img
        src={logo}
        alt="WiSetFi"
